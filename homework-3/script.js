...
async function main() {
    ...
    const culturalInstitutions = await axios('https://raw.githubusercontent.com/lisjak/FOSS-for-WebGIS/main/homework-3/data/cultural-institutions.geojson');
    ...
    const luxuryHousing = await axios('https://github.com/lisjak/FOSS-for-WebGIS/blob/main/homework-3/data/luxury-housing.geojson');
    ...
    // ============ Greenpoint Polygon ============
    const greenpointBounds = await axios('https://raw.githubusercontent.com/lisjak/FOSS-for-WebGIS/main/homework-3/data/greenpoint-bounds.geojson');
